...
import { VRLinkDetailType } from '../types/VRLink/VRLinkType';
...
import { createListingSnapshot } from '../../core/listing/createListingSnapshot';
...
const updateListing = {
  ...
  args: {
    ...
    vr360Data: { type: new List(VRLinkDetailType) },
    bizverseSpaceData: { type: new List(VRLinkDetailType) },
  ...
  async resolve ({ request, response }, {
    ...
    if (request.user || request.user.admin) {
      ...
      await createListingSnapshot(id);
