...
import RefundDataType from './Refund/refundDataType';
// Helpers
import { getNFTsBookedDatesRange } from '../../core/bookedDates';
    ...
    fields: {
        ...
        nftIds: {
            ...
            async resolve(reservation) {
                ...
                const { nftIds: ids } = await getConflictingNFTsWithListing({
                    listId,
                    checkIn,
                    checkOut
                })
