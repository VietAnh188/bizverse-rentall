...
export default async function action({ locale, store }) {
  ...
  if (data && data.getEditStaticPage) {
    ...
    return {
      ...
      component: <UserLayout><Page html={data.getEditStaticPage.content} title={data.getEditStaticPage.metaTitle} /></UserLayout>,
    };
    ...
    return {
      ...
      component: <UserLayout><Page {...dataResult} /></UserLayout>,
    };
