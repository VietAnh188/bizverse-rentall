    ...
    return (
      <div className={s.root}>
        ...
        <div className={s.container}>
          ...
          {
            getRecommendData && getImageBannerData && getMostViewedListingData && getStaticBlockInfoData && !getRecommendData.loading 
            && !getImageBannerData.loading && !getMostViewedListingData.loading && !getStaticBlockInfoData.loading && <div className={s.pageContainer}>
              {
                getRecommendData && getRecommendData.getRecommend && getRecommendData.getRecommend.length > 0 && <div>
                  <h3 className={s.containerTitle}>
                    ...
                    <SeeAll viewType = {VIEW_TYPES.recommended} />
                  </h3>
              ...
              {
                getMostViewedListingData && getMostViewedListingData.GetMostViewedListing && getMostViewedListingData.GetMostViewedListing.length > 0 && <div className={s.pageContainer}>
                  <h3 className={s.containerTitle}>
                    <FormattedMessage {...messages.mostViewed} />
                    <SeeAll viewType = {VIEW_TYPES.mostViewed} />
                  </h3>
