...
import SellNFTEmail from './SellNFTEmail';
import BuyNFTEmail from './BuyNFTEmail';
import NotifyHostNFTSold from './NotifyHostNFTSold'
import NotifyHostNFTTransferred from './NotifyHostNFTTransferred'
import ReceiveNFT from './ReceiveNFTEmail';
import TransferNFT from './TransferNFTEmail';
    ...
    render() {
        ...
        return (
            <div>
                ...
                {
                    type === 'sellNFT' && <SellNFTEmail content={content} />
                }
                {
                    type === 'buyNFT' && <BuyNFTEmail content={content} />
                }
                {
                    type === 'notifyHostNFTSold' && <NotifyHostNFTSold content={content} />
                }
                {
                    type === 'notifyHostNFTTransferred' && <NotifyHostNFTTransferred content={content} />
                }
                {
                    type === 'receiveNFT' && <ReceiveNFT content={content} />
                }
                {
                    type === 'transferNFT' && <TransferNFT content={content} />
                }
            </div>
        );
    }
