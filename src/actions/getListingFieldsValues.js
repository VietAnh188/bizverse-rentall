    ...
    try {
      ...
      if (!data && !data.getListingSettings) {
        ...
        if (step === "2" && !step2DataIsLoaded) {
          ...
          let updatedValuesStep3 = Object.assign({ isPayLater: '0', bookingType: 'request' }, listingFieldsValues, { id: listId }, { currency: baseCurrency }, { bookingType: 'instant' }, { maxDaysNotice: 'available' });
