    ...
    try {
      ...
      if (data && data.UserListing) {
        ...
        const initFormValues = {
          ...data.UserListing,
          isPayLater: String(data.UserListing.isPayLater) === 'true' ? '1' : '0' // Pass this value to Redux form Field radio
        }

        formValues = Object.assign(initFormValues, settingFieldsData, listData, calendars);
