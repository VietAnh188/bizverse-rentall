...
class Refund extends Component {
  ...
  handleClick = async () => {
    ...
    const initialData = {
      ...
      payEmail: transactionData.payerEmail
    };
  ...
  render() {
    ...
    const refundReservationState = ['expired', 'cancelled', 'declined']

    if (refundReservationState.includes(reservationState)) {
      ...
      if (refundData?.id || (completed && reservationId === id)) {
