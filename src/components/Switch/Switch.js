...
export const uncheckedIcon = (
    <svg className="unchecked-icon" viewBox="0 0 52 52" fill="currentColor" fillOpacity="0"
...
export const checkedIcon = (
    <svg className='checked-icon' viewBox="0 0 52 52" fill="currentColor" fillOpacity="0"
        stroke="currentColor" strokeWidth="3"
        role="presentation" strokeLinecap="round" strokeLinejoin="round"
        style={{ position: "absolute", top: 1, height: '30px', width: '30px', display: 'block', transform: 'scale(1.5)' }}>
