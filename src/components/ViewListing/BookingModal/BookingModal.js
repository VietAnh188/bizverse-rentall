...
class BookingModal extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Modal className='bizverse-container' show={bookingModalStatus} animation={false} onHide={closeBookingModal} dialogClassName={cx(s.logInModalContainer, 'BookingModalNew', 'viewListModal', 'bizverse-box-secondary')} >
                    <Modal.Header closeButton className={s.bookingModalClose}>
                    </Modal.Header>
                    <Modal.Body bsClass={cx(s.logInModalBody)}>
                        <Calendar
                            id={id}
                            loading={loading}
