  ...
  render() {
    ...
    return (
      <div className={s.root}>
        <Modal 
          dialogClassName='bizverse-box-secondary' 
          show={showContactHostModal} 
          onHide={contactHostClose} 
          animation={false} 
          className={cx(s.modalContainer, 'ContactHost', 'bizverse-container')}
        >
                                  ...
                                  <Col lg={12} md={12} sm={12} xs={12} className={s.spaceTop2}>
                                    <div className={s.messagePanel}>
                                      <Field
                                        ...
                                        className={cx(s.textBox, s.bizverseBox, s.bizverseBoxSecondary)}
