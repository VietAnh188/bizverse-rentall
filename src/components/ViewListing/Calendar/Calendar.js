    ...
    render() {
        ...
        return (
            <div className={cx(s.bookItContainer, 'bookItContentCommon', 'modalMarginTop')}>
                <div className={cx(s.bookItContentBox, 'bizverse-box-secondary')} data-sticky-section>
                    <div className={cx(s.bootItPriceSection, 'bootItPriceSection', 'borderRadiusNone')}>
                    ...
                    <div className={cx('bookItFormSection')}>
                        ...
                        >
                            <div className={cx(s.bookItPanel, 'borderRadiusNone', 'bookItPanelRtl')}>
                                ...
                                />
                                <div>
                                    <FormGroup className={cx(s.formGroup, s.textMuted, s.textMutedSmall, 'text-center')}>
