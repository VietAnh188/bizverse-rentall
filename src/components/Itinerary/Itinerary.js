...
class Itinerary extends React.Component {
  ...
  render() {
    ...
    if (data === null) {
      ...
      return (
        <div className={cx(s.Container, 'ViewProfile')}>
          <div className={s.containerResponsive}>
            <section className={cx(s.space4)}>
            ...
            <Row>
              <Col md={7} lg={7}>
                <Panel className={cx(s.cardPanel, s.bizverseBox, s.bizverseBoxSecondary)}>
                  <div className={cx(s.paneBody)}>
                    <Row className={cx(s.rowTable, s.dateRange)}>
                      <div className={s.hideSm}>
                        <Col sm={3} md={3} lg={3}>
                          <span className={s.textBolder}>
                  ...
                  <div className={cx(s.textCenter, s.panelBody)}>
                    <Row className={cx(s.rowTable)}>
                      <Col md={3} lg={3} className={s.space1}>
                        <span className={s.textBolder}><FormattedMessage {...messages.host} /></span>
                      </Col>
                  ...
                  <div className={cx(s.textCenter, s.panelBody)}>
                    <Row className={cx(s.rowTable)}>
                      <Col md={3} lg={3}>
                        <span className={s.textBolder}><FormattedMessage {...messages.billing} /></span>
                      </Col>
                      <Col md={9} lg={9}>
