        ...
        return (
            <div className={'inputFocusColor'}>
                <form onSubmit={handleSubmit(this.submitForm)} autoComplete="off" className={s.formContainer}>
                    {
                        shown && <div className={s.btnSection}><a className={cx(s.btnText, s.labelText, s.pullRight, s.noMargin, s.paddingRight, s.button, bt.btnLarge)} onClick={this.toggle}>
                    ...
                    }
                    {
                        !shown && <div>
                            ...
                            <FormGroup className={cx(s.spaceTop3, s.formGroup)}>
                                ...
                                <Button className={cx(s.cancelCreateWishList, s.bizverseButtonSecondary, s.marginLeft, 'arCreateWish')}
                                    disabled={submitting}
                                    onClick={this.toggle}>
