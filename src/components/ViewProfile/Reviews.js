  ...
  render() {
    ...
    return (
      <div className={cx(s.recommendations, s.spaceTop4)}>
        ...
        {
          showLoadMore && <div className={cx(s.space2, s.textCenter, s.loadMoreText)}><a className={cx(bt.btnPrimary)} onClick={() => loadMore()}><FormattedMessage {...messages.loadMore} />...</a></div>
        }
