    ...
    return (
      <div className={className}>
        <div ref={this.setBtnWrapperRef}>
          <button
            className={cx({ [s.btnSearchActive]: (isExpand === true || (priceRange && priceRange.length > 1)) }, s.btn, s.responsiveFontsize, s.searchBtn)}
        ...
        {
          isExpand && <div className={cx(s.searchFilterPopover, 'searchFilterPopoverRtl', 'bizverse-box-secondary')} ref={this.setWrapperRef}>
