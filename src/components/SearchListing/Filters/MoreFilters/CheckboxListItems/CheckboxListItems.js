    ...
    if (restArray && restArray.length > 0) {
      return (
        <div className={s.space2}>
          ...
          <Button bsStyle="link" type="button" className={cx(s.btn, s.btnLink, s.btnLinkSecondary, s.toggleLink, s.captionTitle, s.filterToggleLink, s.dropdownOverflow, s.showHideBtn)}
