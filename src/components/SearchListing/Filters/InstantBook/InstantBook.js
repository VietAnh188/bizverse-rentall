    ...
    return (
      <div className={className}>
        <div ref={this.setBtnWrapperRef}>
          <button
            className={cx({ [s.btnSearchActive]: (isExpand === true || bookingType == 'instant') }, s.btn, s.responsiveFontsize, s.searchBtn)}
        ...
        {
          isExpand && <div className={cx(s.searchFilterPopover, s.searchFilterPopoverInstantBook, 'searchFilterPopoverRtl', 'bizverse-box-secondary')} ref={this.setWrapperRef}>
