...
class PaymentReceipt extends React.Component {
    ...
    render() {
        ...
        if (data === null) {
            ...
            isDayTotal = dayPrice; //isAverage.toFixed(2) * dayDifference;
            dayPrice = isDayTotal;
                ...
                <div className={cx(s.containerResponsive, s.spaceTop4)}>
                    <div className={cx(s.space4, s.rowTable)}>
                        <Col xs={12} sm={12} md={3} lg={3} className={s.noPadding}>
                            ...
                            <span className={s.textBold}><FormattedMessage {...messages.receipt} /> # {id}</span>
                        </Col>
                    </div>

                    <div>
                        <Panel className={cx(s.receiptPanel, s.bizverseBox, s.bizverseBoxSecondary, 'receiptPanelPrint')}>
                            <h2><FormattedMessage {...messages.customerReceipt} /></h2>
                            <div className={cx(s.spaceTop1, s.pullRight, 'seeALlAr')}>
                                <a className={cx(s.button, bt.btnPrimary, bt.btnLarge, "hidden-print")} onClick={this.print}>
                                    ...
                                    <table className={cx('tableBorderPrint', 'table', 'table-bordered')}>
                                        <tbody>
                                            ...
                                            <tr className={cx(s.positionR)}>
                                                <th className={cx(s.rowWidth, s.displayTable, s.borderLine, 'printThCss')}>
                                                    ...
                                                    <div className={cx('directionLtr', s.displayTableCell, s.displayTableCellMiddle, s.paddingContent, s.lineContentFirst)}>
                                                        <CurrencyConverter
                                                            // amount={basePrice}
                                                            amount={isAverage}
                                                            from={currency}
                    ...
                    <div className={s.spaceTop4}>
                        <p className={cx(s.textBold, s.textJustify)}>
