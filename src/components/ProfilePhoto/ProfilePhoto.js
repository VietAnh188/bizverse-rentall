...
class ProfilePhotoUploadForm extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={cx('commonListingBg', 'profile-photo-container')}>
          ...
          <Row>
            ...
            <Col xs={12} sm={6} md={8} lg={8}>
              ...
              <div className={s.centerFlex}>
                <Col xs={12} sm={4} md={4} lg={4} className={cx(s.spaceTop2, s.fullWidth, s.button, bt.btnPrimaryBorder, s.uploadProfileButton, s.bizverseButtonSecondary, s.noPadding)}>
