          ...
          <Col xs={12} sm={12} md={12} lg={12}>
            <div className={cx(s.mainhedding, 'mainheddingRTLMobile')}>
              ...
              <Col xs={12} sm={6} md={6} lg={6} className={s.faqcolumn}>
                ...
                {data && data.faqTitle1 && <Collapsible triggerOpenedClassName={s.questionOpen} triggerClassName={s.question} transitionTime="200" trigger={<FormattedMessage {...messages.becomeAHostPart5Question1}/>}>
                  <p>
                    <FormattedMessage {...messages.becomeAHostPart5Answer1}/>
                  </p>
                </Collapsible>}
              ...
              <Col xs={12} sm={6} md={6} lg={6} className={s.faqcolumn}>
                ...
                {data && data.faqTitle2 && <Collapsible triggerOpenedClassName={s.questionOpen} triggerClassName={s.question} transitionTime="200" trigger={<FormattedMessage {...messages.becomeAHostPart5Question2}/>}>
                  <p>
                  <FormattedMessage {...messages.becomeAHostPart5Answer2}/>
                  </p>
                </Collapsible>}
