												...
												<li>
													<div className={s.displayTable}>
														<div className={s.displayTableRow}>
															...
															<div className={cx(s.displayTableCell, s.contentReview, 'dashRightBg')}>
																<div className={cx(s.mediaDisplayCell, s.textAlignCenter, s.rightBg)}>
																	...
																	<div className={s.flexLinkReview}>
