          ...
          return (
            <li className={cx(s.listContent, s.listContentWidth)} key={index}>
              ...
              <span className={cx(s.checkBoxSection, s.checkBoxLabel)}>
                <span className={cx(s.checkboxLabel, s.checkBoxSection)}>
                  {option.itemName}
                </span>
              </span>
            </li>
            ...
            <div>
              ...
              <form onSubmit={handleSubmit}>
                <div className={s.landingMainContent}>
                  ...
                  <FormGroup className={s.formGroup}>
                    <label className={cx(s.landingLabel, s.landingContentTitle)}><FormattedMessage {...messages.safetyamenities} /></label>
                  ...
                  <div className={s.nextBackButton}>
                    ...
                    <FormGroup className={s.formGroup}>
                      <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                        <Button className={cx(s.button, s.bizverseButtonSecondary, bt.btnLarge, s.pullLeft, 'floatRight')} onClick={() => previousPage("bizverse-world")}>
