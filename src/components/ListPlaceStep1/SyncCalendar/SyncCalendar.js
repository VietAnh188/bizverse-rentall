            ...
            <div>
                ...
                >
                    ...
                    <Col xs={12} sm={12} md={12} lg={12} className={cx(s.spaceTop1, s.space5, s.noPadding)}>
                        <ul className={cx(s.listType, s.btnCalendar, 'listTypeImportCalendar')}>
                            <li className={s.space2}>
                                <Button className={s.btnContainer, bt.btnPrimary} onClick={this.openImportModal}>
                            ...
                            <li>
                                <Button className={s.btnContainer, bt.btnPrimary} onClick={this.openExportModal}>
                                    <div className={s.displayTable}>
                                        <div className={s.displayTableCellVertical}>
