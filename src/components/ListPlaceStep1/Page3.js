              ...
              <form onSubmit={handleSubmit}>
                <div className={s.landingMainContent}>
                  ...
                  <FormGroup className={s.formGroup}>
                    ...
                    <Field name="bedrooms" component={this.renderFormControlSelect} className={cx(s.formControlSelect, s.jumboSelect, s.bizverseBox, s.bizverseBoxSecondary)} >
                      {
                  ...
                  <div className={s.nextBackButton}>
                    ...
                    <FormGroup className={s.formGroup}>
                      <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                        <Button className={cx(s.button, bt.btnLarge, s.pullLeft, s.bizverseButtonSecondary, 'floatRight')} onClick={() => previousPage("room")}>
