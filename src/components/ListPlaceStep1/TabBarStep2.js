  ...
  render() {
    ...
    return (
      <div className={cx(s.progressContainer, s.bizverseBox, s.bizverseBoxSecondary, s.bizverseBorder, 'hidden-xs')}>
        ...
        >
          <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("photos")} href="javascript:void(0);">
        ...
        </div>
        {
          ...
          >
            <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("cover-photo")} href="javascript:void(0);">
        ...
        >
          <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("description")} href="javascript:void(0);">
        ...
        >
          <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("title")} href="javascript:void(0);">
