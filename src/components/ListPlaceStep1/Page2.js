                ...
                <form onSubmit={handleSubmit}>
                  <div className={s.landingMainContent}>
                    <FormGroup className={s.formGroup}>
                      ...
                      <Field name="houseType" component={this.renderFormControlSelect} className={cx(s.formControlSelect, s.jumboSelect, s.bizverseBox, s.bizverseBoxSecondary)} >
                        {
                    ...
                    <FormGroup className={s.formGroup}>
                      ...
                      <Field name="roomType" component={this.renderFormControlSelect} className={cx(s.formControlSelect, s.jumboSelect, s.bizverseBox, s.bizverseBoxSecondary)} >
                        {
                    ...
                    <FormGroup className={s.formGroup}>
                      ...
                      <Field name="buildingSize" component={this.renderFormControlSelect} className={cx(s.formControlSelect, s.jumboSelect, s.bizverseBox, s.bizverseBoxSecondary)} >
                        {
                    ...
                    <FormGroup className={s.formGroup}>
                      ...
                      <div>
                        <label className={cx(s.blockRadioButton, s.landingLabel, s.bizverseBox, s.bizverserBoxSecondary)}>
                          <FormattedMessage {...messages.yesText} /> <Field name="residenceType" component="input" type="radio" value="1" className={cx(s.pullRight, 'floatLeft')} />
                        </label>
                        <label className={cx(s.blockRadioButton, s.landingLabel, s.bizverseBox, s.bizverserBoxSecondary)}>
                          <FormattedMessage {...messages.noText} /> <Field name="residenceType" component="input" type="radio" value="0" className={cx(s.pullRight, 'floatLeft')} />
                        </label>
                      </div>
                    </FormGroup>
                      ...
                      <div className={s.nextBackButton}>
                        ...
                        <FormGroup className={s.formGroup}>
                          <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                            <Button className={cx(s.button, bt.btnLarge, s.pullLeft, s.bizverseButtonSecondary, 'floatRight')} onClick={() => previousPage(path)}>
