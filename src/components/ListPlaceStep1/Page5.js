...
class Page5 extends Component {
  ...
  // componentDidUpdate() {
  //   const inputElements = document.getElementsByClassName('search-location-input');

  //   if (inputElements.length) {
  //     inputElements[0].onpaste = e => e.preventDefault()
  //   }
  // }
    ...
    return (
      <div>
        ...
        <PlacesSuggest
          {...input}
          label={label}
          className={`${className} search-location-input`}
        />
      </div>
    )
  }
        ...
        <div className={s.landingMainContent}>
          ...
          <FormGroup className={s.formGroup}>
            <Field
              ...
              className={cx(s.formControlInput, s.jumboInput, s.bizverseBox, s.bizverseBoxSecondary)}
            />
          </FormGroup>
        </div>
          ...
          <div className={s.nextBackButton}>
            ...
            <FormGroup className={s.formGroup}>
              <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                <Button className={cx(s.button, s.bizverseButtonSecondary, bt.btnLarge, s.pullLeft, 'floatRight')} onClick={() => previousPage("bathrooms")}>
      ...
      <div>
        <div className={s.landingMainContent}>
          ...
          <FormGroup className={s.formGroup}>
            ...
            <Field name="country" component={this.renderCountryList} className={cx(s.formControlSelect, s.jumboSelect, s.formControlSelectLarge, s.bizverseBox, s.bizverseBoxSecondary)} />
          </FormGroup>
