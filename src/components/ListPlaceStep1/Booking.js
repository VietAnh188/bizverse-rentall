            ...
            <form onSubmit={handleSubmit}>
              ...
              <FormGroup className={s.formGroup}>
                <ControlLabel className={s.landingLabel}>
                  <h3 className={s.landingContentTitle}><FormattedMessage {...messages.canGuestPayLater} /></h3>
                </ControlLabel>
                <div>
                  <label className={cx(s.blockRadioButton, s.landingLabel, s.bizverseBox, s.bizverserBoxSecondary)}>
                    <FormattedMessage {...messages.yesText} /> <Field name="isPayLater" component="input" type="radio" value="1" className={cx(s.pullRight, 'floatLeft' )} />
                  </label>
                  <label className={cx(s.blockRadioButton, s.landingLabel, s.bizverseBox, s.bizverserBoxSecondary)}>
                    <FormattedMessage {...messages.noText} /> <Field name="isPayLater" component="input" type="radio" value="0" className={cx(s.pullRight, 'floatLeft')} />
                  </label>
                </div>
              </FormGroup>

              <div className={cx(s.nextPosition, s.nextPositionCalendar, s.bizverseBox, s.bizverseBoxSecondary)}>
                <div className={s.nextBackButton}>

                  <FormGroup className={s.formGroup}>
                    <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                      <Button className={cx(s.button, s.bizverseButtonSecondary, bt.btnLarge, s.pullLeft, 'floatRight')} onClick={() => previousPage("discount")}>
