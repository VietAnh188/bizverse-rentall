...
import BizverseWorldLocation from './BizverseWorldLocation';
...
class ListPlaceStep1 extends Component {
  ...
  renderTabBar(currentPage) {
    ...
    const step1Pages = [
      "room", "bedrooms", "bathrooms", "location", "map", "bizverse-world", "amenities", "spaces"
    ];
    const step2Pages = [
  ...
  render() {
    ...
    return (
      <div className={'inputFocusColor'}>
        ...
        {currentPage === "bizverse-world" && <BizverseWorldLocation
          listId={listId}
          nextPage={this.nextPage}
          previousPage={this.previousPage}
        />}
