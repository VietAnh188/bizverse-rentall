        ...
        <li className={s.listContent} key={index}>
          ...
          <span className={cx(s.checkBoxSection, s.checkBoxLabel)}>
            <span className={cx(s.checkboxLabel, s.noPadding)}>
              <img
                src={config.AWS_SERVICE_URL + 'images/upload/' + option.name}
                            ...
                            <div className={s.listPhotoCover}>
                              <div className={s.listPhotoMedia}>
                                <img className={s.imgResponsive}
                                  src={config.AWS_SERVICE_URL +'images/upload/x_medium_' + option.name}
                                />
                              </div>
                  ...
                  <div className={s.nextBackButton}>
                    ...
                    <FormGroup className={s.formGroup}>
                      <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                        <Button className={cx(s.button, s.bizverseButtonSecondary, bt.btnLarge, s.pullLeft, 'floatRight')} onClick={() => previousPage("photos")}>
