          ...
          <Col xs={12} sm={12} md={12} lg={12} className={s.landingContent}>
            <div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className={cx(s.nextPosition, s.nextPositionMap, s.bizverseBox, s.bizverseBoxSecondary)}>
                  <div className={s.nextBackButtonMap}>
                    {/* <hr className={s.horizontalLineThrough} /> */}
                    <FormGroup className={s.formGroup}>
                      <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                        <Button className={cx(s.button, s.bizverseButtonSecondary, bt.btnLarge, s.pullLeft, 'floatRight')} onClick={() => previousPage("location")}>
                          <FormattedMessage {...messages.back} />
                        </Button>
                        <Button className={cx(s.button, bt.btnPrimary, bt.btnLarge, s.pullRight, 'floatLeft')} onClick={() => nextPage("bizverse-world")} disabled={isDisabled}>
