  ...
  render() {
    ...
    return (
      <div className={cx(s.progressContainer, s.bizverseBox, s.bizverseBoxSecondary, s.bizverseBorder, 'hidden-xs')}>
        ...
        >
          <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("bedrooms")} href="javascript:void(0);">
        ...
        >
          <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("bathrooms")} href="javascript:void(0);">
        ...
        >
          <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("map")} href="javascript:void(0);">
        ...
        <div
          className={cx(s.textTrunck, s.progressSection, s.progressStyle,
            { [s.active]: pathname === "bizverse-world" })}
          title={formatMessage(messages.bizverseWorld)}
        >
          <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("bizverse-world")} href="javascript:void(0);">
            <FormattedMessage {...messages.bizverseWorld} />
          </a>
        </div>
        ...
        >
          <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("amenities")} href="javascript:void(0);">
        ...
        >
          <a className={cx(s.linkReset, s.progressStep, s.bizverseBorderLeft)} onClick={() => nextPage("spaces")} href="javascript:void(0);">
