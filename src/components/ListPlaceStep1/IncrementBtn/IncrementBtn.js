  ...
  render() {
    ...
    return (
      <div className={cx(s.incrementDecrementButton, s.bizverseBox, s.bizverseBoxSecondary)}>
        ...
        <Button className={cx(s.iconButton, s.bizverseBorderLeft)} onClick={this.decrement} disabled={isDisableDecrement}>
          <FontAwesome.FaMinus />
        </Button>
        <Button className={cx(s.iconButton, s.bizverseBorderLeft)} onClick={this.increment} disabled={isDisableIncrement}>
          <FontAwesome.FaPlus />
        </Button>
      </div>
    )
