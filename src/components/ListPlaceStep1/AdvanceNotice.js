              ...
              <form onSubmit={handleSubmit}>
                <div className={s.landingMainContent}>
                  <FormGroup className={s.formGroup}>
                    <Field name="bookingNoticeTime" component={this.renderFormControlSelect} className={cx(s.formControlSelect, s.jumboSelect, s.bizverseBox, s.bizverseBoxSecondary)} >
                      {
                  ...
                  <FormGroup className={s.formGroup}>
                    ...
                    <Field
                      ...
                      className={cx(s.formControlSelect, s.jumboSelect, s.bizverseBox, s.bizverseBoxSecondary)}
                      startValue={8}
                      endValue={25}
                    />
                  </FormGroup>
                  ...
                  <div className={s.nextBackButton}>
                    ...
                    <FormGroup className={s.formGroup}>
                      <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                        <Button className={cx(s.button, s.bizverseButtonSecondary, bt.btnLarge, s.pullLeft, 'floatRight')} onClick={() => previousPage("review-how-guests-book")}>
