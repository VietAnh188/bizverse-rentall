					...
					<div className={s.pageContainer}>
						<div className={s.activationStepPanel}>
							<div className={s.panelBody}>
								...
								<Col xs={12} sm={12} md={12} lg={12} className={cx(s.spaceTop2, s.fullWidth, s.noPadding, s.bizverseButtonSecondary, s.btnlarge, 'avatarDroupZone')}>
									<DropZone
								...
								<Col xs={12} sm={12} md={12} lg={12} className={cx(s.noPadding, s.spaceTop2)}>
									{
										guestPicture && <Button
											className={cx(bt.btnPrimary, bt.fullWidth)}
