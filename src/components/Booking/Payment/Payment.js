...
//Images
import RightArrowIcon from '../../../../public/SiteIcons/icon-arrow-right.png';
...
class Payment extends Component {
  ...
  render() {
    ...
    // Example priceForDays = 10, dayDifference = 3
    // isAverage = 3.33333333
    // isDayTotal = isAverage.toFixed(2) * dayDifference = 9.99;
    // backend validate 10 === 9.99
    // return false
    isAverage = Number(priceForDays) / Number(dayDifference);
    isDayTotal = priceForDays //isAverage.toFixed(2) * dayDifference;
            ...
            <div className={cx(s.summaryCard, s.colCenter)}>
              ...
              <Panel className={cx(s.panelHeader, s.bizverseBox, s.bizverseBoxSecondary)}>
                <div className={s.spaceTop2}>
                  ...
                  <div className={s.bizverseSplitter} />
                </div>
