            ...
            <div className={s.panelBody}>
              ...
              }
              {
                !loading && getPaymentMethods != undefined && getPaymentMethods.length > 0 && <div className={'payoutTable'}>
                  <table className={cx('table', s.noBorder, s.tablePayout)}>
                    <thead>
                    ...
                    <tbody>
                      {
                        getPaymentMethods.map((item, index) => {
                          if (item.id === paymentMethods.PAY_LATER_ID || item.id === paymentMethods.ONE_FIN_PAYMENT_ID) {
                            return null;
                          }
                          ...
                          if (item.isEnable) {
                            return (
                              <tr className={cx(s.sectionTitleLight, s.rowBorder)} key={index}>
                                <td >
