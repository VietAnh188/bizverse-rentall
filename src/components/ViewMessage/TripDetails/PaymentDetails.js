	...
	render() {
		...
		return (
			<div className={s.paymentDetailWrapper}>
				...
				{
					isCleaningPrice > 0 && <Row className={s.textWhite}>
						<Col xs={7} sm={7} className={cx(s.textLeft, 'textAlignRightRtl')}>
				...
				{/* 
				{
					taxRateFee > 0 && <Row className={s.textWhite}>
				...
				{
					discount > 0 && <Row className={s.textWhite}>
						<Col xs={7} sm={7} className={cx(s.textLeft, 'textAlignRightRtl')}>
				...
				{
					userType === 'guest' && guestServiceFee > 0 && <Row className={s.textWhite}>
						<Col xs={7} sm={7} className={cx(s.textLeft, 'textAlignRightRtl')}>
				...
				{
					userType === 'host' && hostServiceFee > 0 && <Row className={s.textWhite}>
						<Col xs={6} sm={6} className={cx(s.textLeft, 'textAlignRightRtl')}>
							<span><FormattedMessage {...messages.serviceFee} /></span>
						</Col>
						<Col xs={6} sm={6} className={cx(s.textRight, 'textAlignLeftRtl')}>
