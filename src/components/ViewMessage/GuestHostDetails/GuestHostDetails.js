    ...
    return (
      <div className={s.guestHost}>
        ...
        <div className={s.hostChat}>
          <Link to={'/users/show/' + guestProfileId}>
            {
              guestImage && <Image src={config.AWS_SERVICE_URL + 'images/avatar/medium_' + guestImage} responsive />
            }
            {
        ...
        <div className={s.hostChat}>
          <Link to={'/users/show/' + hostProfileId}>
            {/* <Image src={config.AWS_SERVICE_URL + 'images/avatar/medium_' + hostImage} responsive /> */}
            {
              hostImage && <Image src={config.AWS_SERVICE_URL + 'images/avatar/medium_' + hostImage} responsive />
            }
            {
