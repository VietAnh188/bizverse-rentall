...
class HomeHeader extends React.Component {
  ...
  render() {
    const { siteSettings, borderLess, showMenu, toggleOpen, layoutType, showGlobalIndicator } = this.props;
    const { searchHide, load } = this.state;
    let borderClass, headerDesignClass, languageDesignClass;
    let location;
    ...
    return (
      <>
        <div className={cx(headerDesignClass, languageDesignClass)}>
