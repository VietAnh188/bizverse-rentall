...
// Public listing
export const SITE_ADMIN_PUBLIC_LISTING_START = 'SITE_ADMIN_PUBLIC_LISTING_START';
export const SITE_ADMIN_PUBLIC_LISTING_SUCCESS = 'SITE_ADMIN_PUBLIC_LISTING_SUCCESS';
export const SITE_ADMIN_PUBLIC_LISTING_ERROR = 'SITE_ADMIN_PUBLIC_LISTING_ERROR';
...
// REQUEST PAYMENT
export const ONE_FIN_PAYMENT_REQUEST_START = 'ONE_FIN_PAYMENT_REQUEST_START';
export const ONE_FIN_PAYMENT_REQUEST_SUCCESS = 'ONE_FIN_PAYMENT_REQUEST_SUCCESS';
export const ONE_FIN_PAYMENT_REQUEST_ERROR = 'ONE_FIN_PAYMENT_REQUEST_ERROR';

// ONE FIN PAYMENT STATUS
export const GET_ONE_FIN_PAYMENT_STATUS_START = 'GET_ONE_FIN_PAYMENT_STATUS_START';
export const GET_ONE_FIN_PAYMENT_STATUS_SUCCESS = 'GET_ONE_FIN_PAYMENT_STATUS_SUCCESS';
export const GET_ONE_FIN_PAYMENT_STATUS_ERROR = 'GET_ONE_FIN_PAYMENT_STATUS_ERROR';

// CANCEL SUBMIT LISTING
export const CANCEL_SUBMIT_LISTING_START = 'CANCEL_SUBMIT_LISTING_START';
export const CANCEL_SUBMIT_LISTING_SUCCESS = 'CANCEL_SUBMIT_LISTING_SUCCESS';
export const CANCEL_SUBMIT_LISTING_ERROR = 'CANCEL_SUBMIT_LISTING_ERROR';

// CURRENT VIEW LISTING
export const SET_CURRENT_VIEW_LISTING = 'SET_CURRENT_VIEW_LISTING';

// CHECK USER WALLET
export const CHECK_USER_WALLET_START = 'CHECK_USER_WALLET_START';
export const CHECK_USER_WALLET_SUCCESS = 'CHECK_USER_WALLET_SUCCESS';
export const CHECK_USER_WALLET_ERROR = 'CHECK_USER_WALLET_ERROR'

// GET USER PAYLOAD
export const GET_USER_PAYOUT_START = 'GET_USER_PAYOUT_START';
export const GET_USER_PAYOUT_SUCCESS = 'GET_USER_PAYOUT_SUCCESS';
export const GET_USER_PAYOUT_ERROR = 'GET_USER_PAYOUT_ERROR';

// Indicator
export const SHOW_GLOBAL_INDICATOR = 'SHOW_GLOBAL_INDICATOR';
export const HIDE_GLOBAL_INDICATOR = 'HIDE_GLOBAL_INDICATOR'

// CREATE NFT
export const CREATE_NFT_START = 'CREATE_NFT_START';
export const CREATE_NFT_SUCCESS = 'CREATE_NFT_SUCCESS';
export const CREATE_NFT_ERROR = 'CREATE_NFT_ERROR';

// GET NFTs
export const GET_NFTs_START = 'GET_NFTs_START';
export const GET_NFTs_SUCCESS = 'GET_NFTs_SUCCESS';
export const GET_NFTs_ERROR = 'GET_NFTs_ERROR';

// GET NFT
export const GET_NFT_START = 'GET_NFT_START';
export const GET_NFT_SUCCESS = 'GET_NFT_SUCCESS';
export const GET_NFT_ERROR = 'GET_NFT_ERROR';

// BURN NFTs
export const BURN_NFTs_START = 'BURN_NFTs_START';
export const BURN_NFTs_SUCCESS = 'BURN_NFTs_SUCCESS';
export const BURN_NFTs_ERROR = 'BURN_NFTs_ERROR';
...
// SYNC social data
export const SYNC_SOCIAL_START = 'SYNC_SOCIAL_START';
export const SYNC_SOCIAL_SUCCESS = 'SYNC_SOCIAL_SUCCESS';
export const SYNC_SOCIAL_ERROR = 'SYNC_SOCIAL_ERROR';
...
//MAINTENANCE
export const GET_MAINTENANCE_STATUS_START = 'GET_MAINTENANCE_STATUS_START';
export const GET_MAINTENANCE_STATUS_SUCCESS = 'GET_MAINTENANCE_STATUS_SUCCESS';
export const GET_MAINTENANCE_STATUS_ERROR = 'GET_MAINTENANCE_STATUS_ERROR';
export const MAINTENANCE_START = 'MAINTENANCE_START';
export const START_MAINTENANCE_SUCCESS = 'START_MAINTENANCE_SUCCESS';
export const START_MAINTENANCE_ERROR = 'START_MAINTENANCE_ERROR';
export const STOP_MAINTENANCE_START = 'STOP_MAINTENANCE_START';
export const STOP_MAINTENANCE_SUCCESS = 'STOP_MAINTENANCE_SUCCESS';
export const STOP_MAINTENANCE_ERROR = 'STOP_MAINTENANCE_ERROR';
export const SET_MAINTENANCE = 'SET_MAINTENANCE';

// CHANGE VIEWTYPE SEARCH LISTING
...
// SAVE TYPE LINK
export const SAVE_TYPE_ERROR = 'SAVE_TYPE_ERROR';
export const SAVE_TYPE_START = 'SAVE_TYPE_START';
export const SAVE_TYPE_SUCCESS = 'SAVE_TYPE_SUCCESS';

// REMOVE TYPE LINK
export const REMOVE_TYPE_ERROR = 'REMOVE_TYPE_ERROR';
export const REMOVE_TYPE_START = 'REMOVE_TYPE_START';
export const REMOVE_TYPE_SUCCESS = 'REMOVE_TYPE_SUCCESS';

// GET ALL TYPE LINKS
export const GET_TYPE_LINKS_ERROR = 'GET_TYPE_LINKS_ERROR';
export const GET_TYPE_LINK_START = 'GET_TYPE_LINK_START';
export const GET_TYPE_LINK_SUCCESS = 'GET_TYPE_LINK_SUCCESS';

// TOGGLE NFT TRENDING
export const TOGGLE_NFT_TRENDING_ERROR  = 'TOGGLE_NFT_TRENDING_ERROR';
export const TOGGLE_NFT_TRENDING_START = 'TOGGLE_NFT_TRENDING_START';
export const TOGGLE_NFT_TRENDING_SUCCESS = 'TOGGLE_NFT_TRENDING_SUCCESS';

// SAVE TYPE LINK SPACE
export const SAVE_SPACE_ERROR = 'SAVE_SPACE_ERROR';
export const SAVE_SPACE_START = 'SAVE_SPACE_START';
export const SAVE_SPACE_SUCCESS = 'SAVE_SPACE_SUCCESS';

// REMOVE TYPE LINK SPACE
export const REMOVE_TYPE_SPACE_ERROR = 'REMOVE_TYPE_SPACE_ERROR';
export const REMOVE_TYPE_SPACE_START = 'REMOVE_TYPE_SPACE_START';
export const REMOVE_TYPE_SPACE_SUCCESS = 'REMOVE_TYPE_SPACE_SUCCESS';

// GET ALL TYPE LINKS
export const GET_SPACE_LINKS_ERROR = 'GET_SPACE_LINKS_ERROR';
export const GET_SPACE_LINK_START = 'GET_SPACE_LINK_START';
export const GET_SPACE_LINK_SUCCESS = 'GET_SPACE_LINK_SUCCESS';
